...
export default {
  async asyncData (context) {
    let info = await context.app.$axios.get('/misc/docPage/international-org')
  ...
  mounted() {
    ...
    // that.$axios.get('/misc/docPage/international-org')
