<template>
  <div class="page-content" data-type="inner">
    ...
    <filters ref="filter" filer="items" post="/purchases/list" :archive="isArchive"></filters>
    ...
    <section data-type="page-content">
      <div class="center">
        ...
        <div class="page-contain">
          <div class="tag-items">
            <item-tags :link="purchase.LINK" :external="true" v-for="purchase in items" :name="purchase.NAME" :date="purchase.DEADLINE" :tags="purchase.TAGS"></item-tags>
          </div>
...
const filters = require('~/components/ui/filters-procure').default;
...
export default {
  async asyncData (context) {
    let info = await context.app.$axios.get('/purchases/list', {
      params: {
        count: 5,
        page: 1
      }
