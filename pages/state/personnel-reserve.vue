...
export default {
  async asyncData (context) {
    let info = await context.app.$axios.get('/misc/docPage/personnel-reserve')

    return { seo: info.data.seo, items: info.data.result, info: info.data.info }
  },
  head() {
    return {
  ...
  mounted() {
    // that.$axios.get('/misc/docPage/the-procedure-of-admission-and-completion-of-the-civil-service')
