...
export default {
  async asyncData (context) {
    let info = await context.app.$axios.get('/misc/docPage/accounting-chamber-legislation')
  ...
  mounted() {
    ...
    // that.$axios.get('/misc/docPage/accounting-chamber-legislation')
...
<style lang="scss" scoped>
  .doc-list {
    .doc-item {
      ...
      .doc-preview, .doc-detail-content {
