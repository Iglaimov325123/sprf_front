<template>
  <div class="page-content" data-type="inner">
    ...
    <section data-type="page-content" id="page-content">
      <div class="center">
        ...
        <div class="page-contain">
          ...
          <div class="statement-list" v-if="check.FILES">
            <statement-simple v-for="file in check.FILES" class="statement-inner" :external="true" :title="file.NAME" :date="file.DATE" :subinfo="file.EXTENSION.toUpperCase()+' ('+file.SIZE+' Мб)'" :link="file.SRC"></statement-simple>
          </div>
        </div>
      </div>
    </section>
...
export default {
  async asyncData (context) {
    console.log(context);
    let page = await context.app.$axios.get(`/nacional_audits/item/${context.route.params.audit}`),
  ...
  mounted() {
    ...
    // that.$axios.get(`/nacional_audits/item/${this.$route.params.audit}`)
...
<style lang="scss" scoped>
  ...
  p.first + .aside-block {
    ...
    // TODO: Версия для слабовидящих страница не заполнена!
</style>
